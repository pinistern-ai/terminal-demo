...
map.getView().fit([3865397.071721, 3741186.604728, 3914137.311989, 3772471.816159], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">TEST1</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (12 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'מפה יפה מאוד';
            }
